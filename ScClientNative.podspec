#
#  Be sure to run `pod spec lint ScClientNative.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/sookim-1/socketcluster-client-swift-native"
  ...
  s.source       = { :git => "https://github.com/sookim-1/socketcluster-client-swift-native.git", :tag => s.version.to_s }
  ...
  s.source_files  = "Sources/ScClientNative/**/*"
